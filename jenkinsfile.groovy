    ...
    stages {
        ...
        stage('Checkout Codebase'){
            steps{
                ...
                [[credentialsId: 'ssh-key', url: 'git@github.com:badam-nikitha/Junit-automation.git']]]
            }
        }
        ...
        stage('Build'){
            steps{
                ...
                bat 'cd src ; javac -cp "F:\JunitAut\lib/junit-platform-console-standalone-1.7.0-all.jar" CarTest.java Car.java App.java'
            }
        }
